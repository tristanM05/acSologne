 ...
 */
final class Version20200427093513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE date (id INT AUTO_INCREMENT NOT NULL, vol_id INT DEFAULT NULL, nb_place INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_AA9E377A9F2BFB7A (vol_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
