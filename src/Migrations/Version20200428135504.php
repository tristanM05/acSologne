 ...
 */
final class Version20200428135504 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE booker_id booker_id INT DEFAULT NULL, CHANGE ad_id ad_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE categories CHANGE tarifs tarifs VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE date ADD vol_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE date ADD CONSTRAINT FK_AA9E377A9F2BFB7A FOREIGN KEY (vol_id) REFERENCES vol (id)');
        $this->addSql('CREATE INDEX IDX_AA9E377A9F2BFB7A ON date (vol_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE date DROP FOREIGN KEY FK_AA9E377A9F2BFB7A');
        $this->addSql('DROP INDEX IDX_AA9E377A9F2BFB7A ON date');
        $this->addSql('ALTER TABLE date DROP vol_id');
        $this->addSql('ALTER TABLE formation CHANGE categories_id categories_id INT DEFAULT NULL');
