 ...
 */
final class Version20200428135907 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD date_id INT DEFAULT NULL, CHANGE booker_id booker_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDEB897366B FOREIGN KEY (date_id) REFERENCES date (id)');
        $this->addSql('CREATE INDEX IDX_E00CEDDEB897366B ON booking (date_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE user_id user_id INT DEFAULT NULL, CHANGE annonce_cat_id annonce_cat_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE booking DROP FOREIGN KEY FK_E00CEDDEB897366B');
        $this->addSql('DROP INDEX IDX_E00CEDDEB897366B ON booking');
        $this->addSql('ALTER TABLE booking DROP date_id, CHANGE booker_id booker_id INT DEFAULT NULL');
