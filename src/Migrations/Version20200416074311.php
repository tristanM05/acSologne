 ...
 */
final class Version20200416074311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photos ADD formation_id INT DEFAULT NULL, CHANGE actu_id actu_id INT DEFAULT NULL, CHANGE machines_id machines_id INT DEFAULT NULL, CHANGE album_id album_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE photos ADD CONSTRAINT FK_876E0D95200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
        $this->addSql('CREATE INDEX IDX_876E0D95200282E ON photos (formation_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photos DROP FOREIGN KEY FK_876E0D95200282E');
        $this->addSql('DROP INDEX IDX_876E0D95200282E ON photos');
        $this->addSql('ALTER TABLE photos DROP formation_id, CHANGE actu_id actu_id INT DEFAULT NULL, CHANGE machines_id machines_id INT DEFAULT NULL, CHANGE album_id album_id INT DEFAULT NULL');
    }
}
