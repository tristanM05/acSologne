 ...
 */
final class Version20200429131309 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD status TINYINT(1) NOT NULL, CHANGE booker_id booker_id INT DEFAULT NULL, CHANGE date_id date_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE user_id user_id INT DEFAULT NULL, CHANGE annonce_cat_id annonce_cat_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE booking DROP status, CHANGE booker_id booker_id INT DEFAULT NULL, CHANGE date_id date_id INT DEFAULT NULL');
