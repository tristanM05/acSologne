 ...
 */
final class Version20200428135748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E00CEDDE4F34D596 ON booking');
        $this->addSql('ALTER TABLE booking DROP ad_id, CHANGE booker_id booker_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE user_id user_id INT DEFAULT NULL, CHANGE annonce_cat_id annonce_cat_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE booking ADD ad_id INT DEFAULT NULL, CHANGE booker_id booker_id INT DEFAULT NULL');
